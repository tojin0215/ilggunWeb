...
class WorkerManageContract extends Component {
  constructor(props) {
    super(props);
    const this_business = this.props.userinfo.business_info.filter(
      (item) => this.props.userinfo.business_name === item.bname,
    )[0];
    this.state = {
      ...
      types3: [
        { label: '근로자에게 직접지급   ', value: 0 },
        { label: '근로자 명의 예금통장에 입금', value: 1 },
      ],
      types4: [0, 0, 0, 0, 0],
      value1: '',
      value1Index: '',
  ...
  handleSubmit() {
    ...
    if (
      this.state.Employer == null ||
      this.state.Employee == null ||
      this.state.StartYear == null ||
      this.state.StartMonth == null ||
      this.state.StartDay == null ||
      this.state.WorkPlace == null ||
      this.state.WorkReference == null ||
      this.state.StartTimeHour == null ||
      this.state.StartTimeHMin == null ||
      this.state.EndTimeHour == null ||
      this.state.EndTimeHMin == null ||
      this.state.WorkingDays == null ||
      this.state.Holiday == null ||
      this.state.Salary == null ||
      this.state.SalaryDay == null ||
      this.state.ContractYear == null ||
      this.state.ContractMonth == null ||
      this.state.ContractDay == null ||
      this.state.BusinessName == null ||
      this.state.BusinessAddress == null ||
      this.state.BusinessOwner1 == null ||
      /*this.state.EmployeeAddress==null||this.state.EmployeePhone==null
        ||this.state.EmployeeName==null||*/ this.state.BusinessPhone == null
    ) {
      alert('빈칸을 채워주세요.');
    } else if (
      !(
        chkNum(this.state.StartYear) === true &&
        chkEng(this.state.StartYear) === false &&
        chkKor(this.state.StartYear) === false &&
        chkSpc(this.state.StartYear) === false
      ) ||
      !(
        chkNum(this.state.StartMonth) === true &&
        chkEng(this.state.StartMonth) === false &&
        chkKor(this.state.StartMonth) === false &&
        chkSpc(this.state.StartMonth) === false
      ) ||
      !(
        chkNum(this.state.StartDay) === true &&
        chkEng(this.state.StartDay) === false &&
        chkKor(this.state.StartDay) === false &&
        chkSpc(this.state.StartDay) === false
      ) ||
      !(
        chkNum(this.state.StartTimeHour) === true &&
        chkEng(this.state.StartTimeHour) === false &&
        chkKor(this.state.StartTimeHour) === false &&
        chkSpc(this.state.StartTimeHour) === false
      ) ||
      !(
        chkNum(this.state.StartTimeHMin) === true &&
        chkEng(this.state.StartTimeHMin) === false &&
        chkKor(this.state.StartTimeHMin) === false &&
        chkSpc(this.state.StartTimeHMin) === false
      ) ||
      !(
        chkNum(this.state.EndTimeHour) === true &&
        chkEng(this.state.EndTimeHour) === false &&
        chkKor(this.state.EndTimeHour) === false &&
        chkSpc(this.state.EndTimeHour) === false
      ) ||
      !(
        chkNum(this.state.EndTimeHMin) === true &&
        chkEng(this.state.EndTimeHMin) === false &&
        chkKor(this.state.EndTimeHMin) === false &&
        chkSpc(this.state.EndTimeHMin) === false
      ) ||
      !(
        chkNum(this.state.WorkingDays) === true &&
        chkEng(this.state.WorkingDays) === false &&
        chkKor(this.state.WorkingDays) === false &&
        chkSpc(this.state.WorkingDays) === false
      ) ||
      !(
        chkNum(this.state.Holiday) === true &&
        chkEng(this.state.Holiday) === false &&
        chkKor(this.state.Holiday) === false &&
        chkSpc(this.state.Holiday) === false
      ) ||
      !(
        chkNum(this.state.Salary) === true &&
        chkEng(this.state.Salary) === false &&
        chkKor(this.state.Salary) === false &&
        chkSpc(this.state.Salary) === false
      ) ||
      !(
        chkNum(this.state.SalaryDay) === true &&
        chkEng(this.state.SalaryDay) === false &&
        chkKor(this.state.SalaryDay) === false &&
        chkSpc(this.state.SalaryDay) === false
      ) ||
      !(
        chkNum(this.state.ContractYear) === true &&
        chkEng(this.state.ContractYear) === false &&
        chkKor(this.state.ContractYear) === false &&
        chkSpc(this.state.ContractYear) === false
      ) ||
      !(
        chkNum(this.state.ContractMonth) === true &&
        chkEng(this.state.ContractMonth) === false &&
        chkKor(this.state.ContractMonth) === false &&
        chkSpc(this.state.ContractMonth) === false
      ) ||
      !(
        chkNum(this.state.ContractDay) === true &&
        chkEng(this.state.ContractDay) === false &&
        chkKor(this.state.ContractDay) === false &&
        chkSpc(this.state.ContractDay) === false
      ) ||
      this.state.StartYear < 2000 ||
      this.state.StartYear > 3000 ||
      this.state.StartMonth < 1 ||
      this.state.StartMonth > 12 ||
      this.state.StartDay < 1 ||
      this.state.StartDay > 31
    ) {
      alert(
        '계약기간, 근로시간, 임금, 계약날짜의 숫자가 제대로 입력되었는지 확인해주세요.',
      );
    } else {
      var flag = true;
      if (
        ...
        if (
          !(
            chkNum(this.state.EndYear) === true &&
            chkEng(this.state.EndYear) === false &&
            chkKor(this.state.EndYear) === false &&
            chkSpc(this.state.EndYear) === false
          ) ||
          !(
            chkNum(this.state.EndMonth) === true &&
            chkEng(this.state.EndMonth) === false &&
            chkKor(this.state.EndMonth) === false &&
            chkSpc(this.state.EndMonth) === false
          ) ||
          !(
            chkNum(this.state.EndDay) === true &&
            chkEng(this.state.EndDay) === false &&
            chkKor(this.state.EndDay) === false &&
            chkSpc(this.state.EndDay) === false
          )
        ) {
      ...
      if (
        !(this.state.BreakTimeStartHour == null) ||
        !(this.state.BreakTimeStartMin == null) ||
        !(this.state.BreakTimeEndHour == null) ||
        !(this.state.BreakTimeEndMin == null)
      ) {
        console.log('근로기간 확인');
        if (
          !(
            chkNum(this.state.BreakTimeStartHour) === true &&
            chkEng(this.state.BreakTimeStartHour) === false &&
            chkKor(this.state.BreakTimeStartHour) === false &&
            chkSpc(this.state.BreakTimeStartHour) === false
          ) ||
          !(
            chkNum(this.state.BreakTimeStartMin) === true &&
            chkEng(this.state.BreakTimeStartMin) === false &&
            chkKor(this.state.BreakTimeStartMin) === false &&
            chkSpc(this.state.BreakTimeStartMin) === false
          ) ||
          !(
            chkNum(this.state.BreakTimeEndHour) === true &&
            chkEng(this.state.BreakTimeEndHour) === false &&
            chkKor(this.state.BreakTimeEndHour) === false &&
            chkSpc(this.state.BreakTimeEndHour) === false
          ) ||
          !(
            chkNum(this.state.BreakTimeEndMin) === true &&
            chkEng(this.state.BreakTimeEndMin) === false &&
            chkKor(this.state.BreakTimeEndMin) === false &&
            chkSpc(this.state.BreakTimeEndMin) === false
          )
        ) {
      ...
      if (!(this.state.Bonus == null)) {
        if (
          !(
            chkNum(this.state.Bonus) === true &&
            chkEng(this.state.Bonus) === false &&
            chkKor(this.state.Bonus) === false &&
            chkSpc(this.state.Bonus) === false
          )
        ) {
      ...
      if (!(this.state.Bonus1 == null)) {
        if (
          !(
            chkNum(this.state.Bonus1) === true &&
            chkEng(this.state.Bonus1) === false &&
            chkKor(this.state.Bonus1) === false &&
            chkSpc(this.state.Bonus1) === false
          )
        ) {
      ...
      if (!(this.state.Bonus2 == null)) {
        if (
          !(
            chkNum(this.state.Bonus2) === true &&
            chkEng(this.state.Bonus2) === false &&
            chkKor(this.state.Bonus2) === false &&
            chkSpc(this.state.Bonus2) === false
          )
        ) {
          alert('기타급여의 숫자가 제대로 입력되었는지 확인해주세요.');
          flag = false;
      ...
      if (!(this.state.Bonus3 == null)) {
        if (
          !(
            chkNum(this.state.Bonus3) === true &&
            chkEng(this.state.Bonus3) === false &&
            chkKor(this.state.Bonus3) === false &&
            chkSpc(this.state.Bonus3) === false
          )
        ) {
          alert('기타급여의 숫자가 제대로 입력되었는지 확인해주세요.');
          flag = false;
      ...
      if (!(this.state.Bonus4 == null)) {
        if (
          !(
            chkNum(this.state.Bonus4) === true &&
            chkEng(this.state.Bonus4) === false &&
            chkKor(this.state.Bonus4) === false &&
            chkSpc(this.state.Bonus4) === false
          )
        ) {
          alert('기타급여의 숫자가 제대로 입력되었는지 확인해주세요.');
          flag = false;
      ...
      if (!(this.state.AdditionalWageRate == null)) {
        if (
          !(
            chkNum(this.state.AdditionalWageRate) === true &&
            chkEng(this.state.AdditionalWageRate) === false &&
            chkKor(this.state.AdditionalWageRate) === false &&
            chkSpc(this.state.AdditionalWageRate) === false
          )
        ) {
          alert(
            '초과근로 가산임금률의 숫자가 제대로 입력되었는지 확인해주세요.',
          );
          flag = false;
        } else {
      ...
      if (!(this.state.SalaryCalculationPeriodStart == null)) {
        if (
          !(
            chkNum(this.state.SalaryCalculationPeriodStart) === true &&
            chkEng(this.state.SalaryCalculationPeriodStart) === false &&
            chkKor(this.state.SalaryCalculationPeriodStart) === false &&
            chkSpc(this.state.SalaryCalculationPeriodStart) === false
          ) ||
          !(
            chkNum(this.state.SalaryCalculationPeriodEnd) === true &&
            chkEng(this.state.SalaryCalculationPeriodEnd) === false &&
            chkKor(this.state.SalaryCalculationPeriodEnd) === false &&
            chkSpc(this.state.SalaryCalculationPeriodEnd) === false
          )
        ) {
  ...
  render() {
    ...
    const isEditMode = this.state.type !== 3;
      ...
      <div className="wrap workercontractwrap">
        ...
        <div className="container">
          ...
          {isEditMode ? (
            <article className="sectionShadow overflow-auto">
              <div className="flex-wrap container">
                <h6 className="text-h4 text-ct w-100 text-bold">
                  표준근로계약서
                </h6>
                ...
                <p className="text-st w-100">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.setState({
                        value1: this.state.value1 === 0 ? 1 : 0,
                        value1Index: this.state.value1 === 0 ? 1 : 0,
                      })
                    }
                  ></input>
                  <input
                ...
                <p className="text-st w-100">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.setState({
                        value2: this.state.value2 === 0 ? 1 : 0,
                        value2Index: this.state.value2 === 0 ? 1 : 0,
                      })
                    }
                  ></input>
                  <span>( </span>
                  <input
                    className="w-100px"
                    type="number"
                    onChange={(e) => this.setState({ Bonus1: e.target.value })}
                  ...
                  <input
                    className="w-100px"
                    type="number"
                    onChange={(e) => this.setState({ Bonus2: e.target.value })}
                ...
                <p>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.setState({
                        value3: this.state.value3 === 0 ? 1 : 0,
                        value3Index: this.state.value3 === 0 ? 1 : 0,
                      })
                    }
                  ></input>
                ...
                <p className="d-flex align-items-center">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.checkedItemHandler('고용보험', e.checked)
                    }
                  ></input>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.checkedItemHandler('산재보험', e.checked)
                    }
                  ></input>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.checkedItemHandler('국민연금', e.checked)
                    }
                  ></input>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.checkedItemHandler('건강보험', e.checked)
                    }
                  ></input>
                </p>
                <p className="text-st w-100 text-bold text-h6">
          ...
          {/* <article className='sectionShadow'>
            {"this.props.location.state.worker.state == 2" === "비활성화시키기" ? 
            (

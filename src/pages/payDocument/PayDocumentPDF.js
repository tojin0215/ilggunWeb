            ...
            <Document>
                <Page size="A4" style={styles.page}>
                    ...
                    <View style={styles.footer}>
                        <Text style={styles.item}>지급액계</Text><Text style={styles.item}>-</Text>
                    </View>
                    <View style={styles.footer}>
                        <Text style={styles.item}>공제액계</Text><Text style={styles.item}>-</Text>
                    </View>
                    <View style={styles.footer}>
                    <Text style={styles.item}>차인지급액계</Text><Text style={styles.item}>-</Text>
                    </View>
                </Page>
            </Document>
        )

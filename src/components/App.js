...
import { Login, Home, WorkerManage, WorkerManageContract, WorkerManageStaff, TaskManage, PayManage, PayManageExtra, PayDocument, PayDocumentDetails, Message, MessageSended, SendMail, Download, SelectBusiness, ExelTable } from '../pages';
  ...
  render() {
    return (
      <div>
        ...
        <Route exact path='/exelTable' component={ExelTable} />
      </div>
    );
  }
}
